...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y libclass-isa-perl 
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y perl perl-modules libswitch-perl 
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y libperl4-corelibs-perl 
